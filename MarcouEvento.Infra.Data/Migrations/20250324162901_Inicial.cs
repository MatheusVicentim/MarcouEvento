        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Neighborhood = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonParties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonParties_Administrators_AdministratorId",
                        column: x => x.AdministratorId,
                        principalTable: "Administrators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonParties_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PersonParties_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonParties_AdministratorId",
                table: "PersonParties",
                column: "AdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonParties_GuestId",
                table: "PersonParties",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonParties_PartyId",
                table: "PersonParties",
                column: "PartyId");
        }
