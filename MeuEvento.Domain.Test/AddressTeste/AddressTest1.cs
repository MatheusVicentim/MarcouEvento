...
namespace MeuEvento.Domain.Test.AddressTeste
{
    public class AddressTest1
    {
        ...
        {
            Action action = () => new Address("R. Carlos Gomes", Address.EType.Residential, 574, "Centro", "São João das Duas Pontes", "SP", "15640047", "", "", "", "Casa");
        ...
        {
            Action action = () => new Address("R. Carlos Gomes", Address.EType.Residential, 574, "Centro", "São João das Duas Pontes", "SP", null, "", "", "", "Casa");
            action.Should()
        ...
        {
            Action action = () => new Address("R. Carlos Gomes", Address.EType.Residential, 574, "Centro", "São João das Duas Pontes", "SP", "156400047", "", "", "", "Casa");
            action.Should()
                    .Throw<MarcouEvento.Domain.Validation.DomainExceptionValidation>()
